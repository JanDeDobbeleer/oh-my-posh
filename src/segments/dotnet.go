...
func (d *Dotnet) Init(props properties.Properties, env environment.Environment) {
	d.language = language{
		...
		versionURLTemplate: "https://github.com/dotnet/core/blob/master/release-notes/{{ .Major }}.{{ .Minor }}/{{ .Major }}.{{ .Minor }}.{{ substr 0 1 .Patch }}/{{ .Major }}.{{ .Minor }}.{{ substr 0 1 .Patch }}.mdx", // nolint: lll
	}
}
