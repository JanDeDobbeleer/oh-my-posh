...
func TestEnabledInBareRepo(t *testing.T) {
	...
	for _, tc := range cases {
		...
		assert.Equal(t, tc.ExpectedHEAD, g.HEAD.String(), tc.Case)
...
func TestEnabledInBareRepoSeparateGitDir(t *testing.T) {
	...
	assert.Equal(t, "branch main", g.HEAD.String())
...
func TestBareUpstreamIcon(t *testing.T) {
	...
	for _, tc := range cases {
		...
		assert.Equal(t, tc.ExpectedIcon, g.UpstreamIcon.String(), tc.Case)
