...
| `enable_cursor_positioning` | `boolean`        | `false` | enable fetching the
cursor position in bash, zsh, and fish to allow automatic hiding of leading newlines when at the top of the shell                                                                                                                                               |
