...
[sprig](http://masterminds.github.io/sprig/) functions. The template context is the
[global context][global-properties]: `.Env.VAR_NAME` for environment variables, `.TerminalWidth`,
`.Shell`, `.PWD`, and so on. Segment-specific properties are **not** available in option
templates.
...
[global-properties]: /docs/configuration/templates#global-properties
