...
| `timeout`                  | `int`        | timeout in milliseconds for segment execution. If the segment takes longer than this value to complete, it will be disabled. Defaults to `0` (no timeout)                                                                                                                                                                                                                                 |
