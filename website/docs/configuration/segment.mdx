...
| `invert_leading`       | `boolean`    | if `true` swaps the leading diamond's foreground and background colors - defaults to `false`                                                                                                                                                                                                                               |
...
| `invert_trailing`      | `boolean`    | if `true` swaps the trailing diamond's foreground and background colors - defaults to `false`                                                                                                                                                                                                                              |
