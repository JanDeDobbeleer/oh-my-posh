...
| `render_pending_icon`      | `string`     |         | override the global pending icon for this segment when using [daemon mode][daemon]                                                                                                                                                                                                                                                                                                        |
| `render_pending_background`| `string`     |         | override the global pending background [color][colors] for this segment when using [daemon mode][daemon]                                                                                                                                                                                                                                                                                  |
