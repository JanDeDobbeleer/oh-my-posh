...
The project has a [winget] [manifest][winget-manifest] file available to install the dependencies.
Navigate to the cloned repository and use winget to install the dependencies:

```powershell
winget configure ./manifests/packages.winget.yml
```
...
The project has a [scoop] [manifest][scoop-manifest] file available to install the dependencies.
Navigate to the cloned repository and use scoop to install the dependencies:

```powershell
scoop install ./manifests/packages.scoop.yml
```
...
[winget-manifest]: https://github.com/JanDeDobbeleer/oh-my-posh/blob/main/manifests/packages.winget.yml
[winget]: https://learn.microsoft.com/en-us/windows/package-manager/winget/
[scoop-manifest]: https://github.com/JanDeDobbeleer/oh-my-posh/blob/main/manifests/packages.scoop.yml
[scoop]: https://https://scoop.sh/
