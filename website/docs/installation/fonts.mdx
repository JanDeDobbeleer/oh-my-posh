...
in `Tools > Options > Fonts and Colors > Terminal` / (In Visual Studio 2022+ in `Tools > Options > Envoronment > Fonts and Colors > Terminal`) and selecting a font like `MesloLGM Nerd Font`.
