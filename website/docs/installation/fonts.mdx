...
## Referencing glyphs in your config

[Templates][templates] reference Nerd Font glyphs using Unicode escape sequences. Glyphs with code points up to
...
:::tip
[FileFormat.info][fileformat] lists every representation for a given glyph.
:::
...
[fileformat]: https://www.fileformat.info/info/unicode/char/F0BC9/index.htm
