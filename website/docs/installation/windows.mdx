...
For the `PATH` to be reloaded, a restart of your terminal is advised. If oh-my-posh is still not recognized as a command, add it manually to path, for example:

```powershell
$env:Path += ";C:\Users\user\AppData\Local\Programs\oh-my-posh\bin"
```

 You can find this path of the binary by searching for `oh-my-posh.exe`.
