...
When a template references `.Version`, the version is fetched and resolved from the first source
...
| `.Version`       | `string` | terraform version, fetched when referenced in a template |
