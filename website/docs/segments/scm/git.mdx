...
| `fetch_bare_info`     |      `boolean`      | `false` | fetch bare repo info: `.Ref`, `.HEAD` and, when `fetch_upstream_icon` is also set, `.Upstream` follow the same rules as in a regular repository                                                                                                                                                                                       |
