...
| `display_ahead_counter` |      `boolean`      | `false` | display a counter for number of changes between working copy and closest bookmark                                                                                                                                                                                |
| `display_ahead_icon`    |      `string`       | `\u21e1`| icon/character between bookmark and ahead counter                                                                                                                                                                                                                |
