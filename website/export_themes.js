...
themeConfigOverrrides.set(
  "amro.omp.json",
  newThemeConfig(40, 100, "AmRo", "#1C2029")
);
...
themeConfigOverrrides.set(
  "craver.omp.json",
  newThemeConfig(40, 80, "Nick Craver", "#282c34")
);
...
themeConfigOverrrides.set(
  "hunk.omp.json",
  newThemeConfig(40, 15, "Paris Qian")
);
...
themeConfigOverrrides.set(
  "night-owl.omp.json",
  newThemeConfig(40, 0, "Mr-Vipi", "#011627")
);
...
`;
    ...
    await fs.promises.appendFile("./docs/themes.mdx", themeData);

    links.push(
      `[${themeName}]: https://github.com/JanDeDobbeleer/oh-my-posh/blob/main/themes/${theme} '${themeName}'\n`
    );
  }

  for (const link of links) {
    await fs.promises.appendFile("./docs/themes.mdx", link);
  }
})();
